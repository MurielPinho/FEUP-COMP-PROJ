...
if (jjtc000) {
  ...
  final public void VarDeclaration1() throws ParseException {/*@bgen(jjtree) VarDeclaration1 */
...
if (jjtc000) {
  ...
  final public void MethodBody() throws ParseException {/*@bgen(jjtree) MethodBody */
...
if (jjtc000) {
  ...
  final public void Type1() throws ParseException {/*@bgen(jjtree) Type1 */
...
if (jjtc000) {
  ...
  final public void Statement1() throws ParseException {/*@bgen(jjtree) Statement1 */
...
if (jjtc000) {
  ...
  final public void Statement2() throws ParseException {/*@bgen(jjtree) Statement2 */
